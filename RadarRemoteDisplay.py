...
PUBLIC_CONFIG_KEYS = {
    ...
    "MapCoastColour", "MapLabelColour", "MapPositionUpdateMinimumM",
    "PlatformTrajectoryEnabled", "PlatformTrajectoryColour",
    "PlatformTrajectoryWidthPx", "PlatformTrajectoryMaximumPoints",
    "PlatformTrajectoryMinimumStepM", "LogoPath", "LogoWidthPx",
